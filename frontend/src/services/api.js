    ...
    if (response) {
      ...
      const msg = (response.data && (response.data.detail || response.data.message)) || i18n.t('errors.generalError');
          try {
            ...
            const tw1 = (twMod && twMod.default) ? twMod.default : twMod;
            if (tw1 && typeof tw1.error === 'function') tw1.error(msg);
      ...
      try {
        ...
        const tw2 = (twReq2 && twReq2.default) ? twReq2.default : twReq2;
        if (tw2 && typeof tw2.error === 'function') tw2.error(i18n.t('errors.networkError') || 'errors.generalError');
      ...
      try {
        ...
        const tw3 = (twReq3 && twReq3.default) ? twReq3.default : twReq3;
        if (tw3 && typeof tw3.error === 'function') tw3.error(i18n.t('errors.generalError'));
