...
// The frontend bootstrap was migrated to TypeScript; import the .ts module
// so repository-level runs pick up the same behavior.
import '../frontend/src/setupTests.ts';